...
class InstructorsControllerTest < ActionController::TestCase
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post :create, instructor: { address: @instructor.address, department_id: @instructor.department_id, email: @instructor.email, mobile: @instructor.mobile, name: @instructor.name, profile: @instructor.profile }
    end
  ...
  test "should update instructor" do
    patch :update, id: @instructor, instructor: { address: @instructor.address, department_id: @instructor.department_id, email: @instructor.email, mobile: @instructor.mobile, name: @instructor.name, profile: @instructor.profile }
    assert_redirected_to instructor_path(assigns(:instructor))
  end
